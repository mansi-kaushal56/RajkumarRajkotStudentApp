...
//  HAPSStudentApp
//
//  Created by Vijay Sharma on 27/01/24.
//
...
let dashboardItemList = [
    DashboardItem(id: "1", title: "Notice Board/Circulars", image: "notice"),
    ...
    DashboardItem(id: "17", title: "School Calendar", image: "schoolcalendar"),
    DashboardItem(id: "18", title: "Gallery", image: "gallery"),
...
//var titleArr = ["Notice Board/Circulars","Inbox","Attendance","Home Work","Assignment","Time Table"/*,"Leave request","leave Status"*/,"Result","Report Card","Feedback/Suggestions","Fee Payment","Fee Ledger","Student Portfolio","Discipline","Library","School Calendar","Gallery","Art Work","Visit Website","News", "Pocket Money","Academic Calendar","Booklist","Class Gallery", "Gate Pass"]
